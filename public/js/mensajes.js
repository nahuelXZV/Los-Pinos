...
Livewire.on("deleteArea", (area) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "area-comun.area-comun.lw-area-comun",
                "delete",
                area
            );
        }
...
Livewire.on("deleteReservaC", (reserva) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "area-comun.calendario.lw-reserva-calendario",
                "delete",
                reserva
            );
        }
...
Livewire.on("deleteInvitado", (invitado) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "area-comun.reserva.lw-lista-invitados",
                "delete",
                invitado
            );
        }
...
Livewire.on("deleteReporte", (reporte) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "area-comun.reserva.lw-reporte-reserva",
                "delete",
                reporte
            );
        }
...
Livewire.on("deleteResidente", (persona) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "seguridad.residente.lw-residente",
                "delete",
                persona
            );
        }
...
Livewire.on("deleteVisitante", (persona) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "seguridad.visitante.lw-visitante",
                "delete",
                persona
            );
        }
...
Livewire.on("deleteMotorizado", (motorizado) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "seguridad.motorizado.lw-motorizado",
                "delete",
                motorizado
            );
        }
...
Livewire.on("deleteVivienda", (vivienda) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "seguridad.vivienda.lw-vivienda",
                "delete",
                vivienda
            );
        }
...
Livewire.on("deleteIngresoV", (ingresoV) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "seguridad.ingreso.lw-lista-persona",
                "deleteV",
                ingresoV
            );
        }
...
Livewire.on("deleteSalida", (salida) => {
    Swal.fire({
        title: "Esta seguro?",
        text: "Los datos se borraran permanentemente!",
        icon: "Advertencia",
        ...
        if (result.isConfirmed) {
            Livewire.emitTo("seguridad.salida.lw-salida", "delete", salida);
        }
    });
});
Livewire.on("deleteSalidaV", (salidaV) => {
    Swal.fire({
        title: "Esta seguro?",
        text: "Los datos se borraran permanentemente!",
        icon: "Advertencia",
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "seguridad.salida.lw-lista-persona",
                "deleteV",
                salidaV
            );
        }
...
Livewire.on("deleteSalidaR", (salidaR) => {
    Swal.fire({
        title: "Esta seguro?",
        text: "Los datos se borraran permanentemente!",
        icon: "Advertencia",
...
Livewire.on("deleteAlmacen", (almacenID) => {
    Swal.fire({
        title: "¿Estás seguro?",
...
Livewire.on("deletePersonal", (personalCodigo) => {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Los datos se borrarán permanentemente",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "personal.personal.show-personal",
                "delete",
                personalCodigo
            );
        }
...
Livewire.on("deleteRegreso", (regresoID) => {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Los datos se borrarán permanentemente",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "equipo.regreso.show-regreso-equipos",
                "delete",
                regresoID
            );
        }
...
Livewire.on("deleteReporteA", (reporteID) => {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Los datos se borrarán permanentemente",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "personal.reporte-asistencia.show-reporte",
                "delete",
                reporteID
            );
        }
...
Livewire.on("deletePermiso", (permisoID) => {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Los datos se borrarán permanentemente",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "personal.reporte-asistencia.show-permisos",
                "delete",
                permisoID
            );
        }
...
Livewire.on("deleteIngresoP", (ingresoPID) => {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Los datos se borrarán permanentemente",
        icon: "warning",
...
Livewire.on("deleteSalidaP", (salidaPID) => {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Los datos se borrarán permanentemente",
        icon: "warning",
...
Livewire.on("deleteReporteT", (reporteID) => {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Los datos se borrarán permanentemente",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "personal.reporte-trabajo.show-reporte",
                "delete",
                reporteID
            );
        }
...
Livewire.on("deleteRealizoT", (realizoID) => {
    Swal.fire({
        title: "¿Estás seguro?",
        text: "Los datos se borrarán permanentemente",
        icon: "warning",
        ...
        if (result.isConfirmed) {
            Livewire.emitTo(
                "personal.reporte-trabajo.show-realizo",
                "delete",
                realizoID
            );
        }
