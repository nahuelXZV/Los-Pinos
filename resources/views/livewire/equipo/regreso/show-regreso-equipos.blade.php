    ...
    <x-table>
        <div class=" px-4 py-6 flex items-center">
            ...
            <a class="font-bold text-white rounded cursor-pointer bg-green-600 hover:bg-green-500 py-2 px-4 "
                @if ($search == '')
                href="{{ route('regresoEquiposlista.pdf', ['_@_', $sort, $direction]) }}"
            @else
                href="{{ route('regresoEquiposlista.pdf', [$search, $sort, $direction]) }}"
                @endif>
            ...
            @can('regresoEquipos.add')
                <x-jet-danger-button class="ml-2 mr-2 bg-green-600 hover:bg-green-500" wire:click="openModal()">
    ...
    auth()->user()->can('regresoEquipos.delete'))
                                <td class="my-3 px-6 py-4 whitespace-nowrap flex">
                                    @can('regresoEquipos.show')
                                        <a class="font-bold text-white rounded cursor-pointer bg-green-600 hover:bg-green-500 py-2 px-4 "
                                            href="{{ route('regresoEquipos.pdf', $regreso->id) }}">
