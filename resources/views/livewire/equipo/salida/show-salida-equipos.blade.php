<div>
    <x-table>
        <div class=" px-4 py-6 flex items-center">
            ...
            <a class="font-bold text-white rounded cursor-pointer bg-green-600 hover:bg-green-500 py-2 px-4 "
                @if ($search == '')
                href="{{ route('salidaEquiposlista.pdf', ['_@_', $sort, $direction]) }}"
            @else
                href="{{ route('salidaEquiposlista.pdf', [$search, $sort, $direction]) }}"
                @endif>
            ...
            <table class=" min-w-full divide-y divide-gray-200 ">
                <thead class=" rounded-3xl bg-green-500 text-white">
                    <tr>
                        ...
                        @if (auth()->user()->can('salidaEquipos.delete') ||
    auth()->user()->can('salidaEquipos.show'))
                    ...
                    @foreach ($salidas as $salida)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500">
                                <span class="font-bold">{{ $salida->personal->codigo }} -</span>
    ...
    auth()->user()->can('salidaEquipos.show'))
                                <td class="my-3 px-6 py-4 whitespace-nowrap flex">
                                    @can('salidaEquipos.show')
                                        <a class="font-bold text-white rounded cursor-pointer bg-green-600 hover:bg-green-500 py-2 px-4 "
                                            href="{{ route('salidaEquipos.pdf', $salida->id) }}">
        ...
        <x-slot name='content'>
            <div class="mb-4 w-full" wire:ignore>
                <label for="id_label_single">
                    ...
                    <select wire:model='codigoP' class="codigoP" style='width: 100%'>
            ...
            <div class="mb-4">
                ...
                <textarea wire:model.defer='motivo'
                    ...
                    rows="2" placeholder="Escriba el motivo"></textarea>
