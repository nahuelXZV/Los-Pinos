<div>
        ...
        <x-table>
            <div class="flex mt-4 ">
                ...
                <x-jet-danger-button wire:click='verifSalida()' class="mr-2 mx-5 bg-blue-600 hover:bg-blue-500"
                    ...
                    Ver Salida del Personal
                </x-jet-danger-button>
            </div>

            <h1 class="mt-4 px-6 py-2 font-mono text-xl font-bold uppercase">Ingreso del Personal: {{$reporte->personal->nombre}}
            </h1>
            <div class="px-6 py-4 flex items-center">
    ...
    @else
        <x-table>
            ...
            <h1 class="mt-4 px-6 py-2 font-mono text-xl font-bold uppercase">Salida del Personal: {{$reporte->personal->nombre}}
            </h1>
            <div class="px-6 py-4 flex items-center">
                <div class="flex items-center">
                    <span class="mr-2 font-semibold">Buscar</span>
