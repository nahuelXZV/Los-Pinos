    ...
    <x-table>
        ...
        <div class="px-6 py-4 flex items-center">
            ...
            <x-jet-input type="text" class="flex-1 mr-2 rounded-full"
                placeholder="Escriba el código del Trabajo realizado" wire:model="search" />

            @can('reporteTrabajo.show.add')
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($realizos as $realizo)
                        <tr>
                            ...
                            @if (auth()->user()->can('reporteTrabajo.show.edit') ||
    auth()->user()->can('reporteTrabajo.show.delete'))
                                <td class="px-6 py-4 whitespace-nowrap flex">
                                    @can('reporteTrabajo.show.edit')
                                    ...
                                    @endcan
                                    @can('reporteTrabajo.show.delete')
