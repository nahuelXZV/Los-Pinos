    ...
    <x-table>
        <div class="px-6 py-4 flex items-center">
            ...
            <a class="font-bold text-white rounded cursor-pointer bg-green-600 hover:bg-green-500 py-2 px-4 "
                @if ($search == '')
                href="{{ route('listaMotorizado.pdf', ['_@_', $sort, $direction]) }}"
            @else
                href="{{ route('listaMotorizado.pdf', [$search, $sort, $direction]) }}"
                @endif>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="rounded-3xl bg-green-500 text-white">
                    <tr>
                        ...
                        @if (auth()->user()->can('motorizados.edit') ||
    auth()->user()->can('motorizados.delete'))
